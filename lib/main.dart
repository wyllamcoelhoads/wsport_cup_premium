...
import 'package:wsports_cup_premium/features/world_cup/domain/entities/team_info_entity.dart';
...
void main() async {
  ...
  // === PASSO 1: DESCOMENTE ESTA LINHA ABAIXO PARA INSERIR O BRASIL ===
  await popularBancoComBrasil();
...
Future<void> popularBancoComBrasil() async {
  final brasil = TeamInfoEntity(
    id: 'br',
    name: 'Brasil',
    flagCode: 'br',
    // URL de uma imagem PNG de alta qualidade do brasão da CBF
    coatOfArmsUrl:
    ...
    captain: 'Marquinhos',
    uniformHomeUrl:
        '', // Deixe vazio por enquanto ou adicione o link de uma imagem
    uniformAwayUrl: '',
    ...
    bio:
        'A Seleção Brasileira é a única a ter participado de todas as edições da Copa do Mundo FIFA. Conhecida mundialmente pelo seu futebol alegre e ofensivo, é a seleção com o maior número de títulos mundiais na história do esporte.',
  );
  ...
  try {
    ...
    print('✅ SUCESSO: Seleção Brasileira inserida no Firestore!');
  } catch (e) {
...
// ─────────────────────────────────────────────────────────────────────────────
// Utilitário de seed do Firebase (rodar apenas uma vez — mantenha comentado)
// ─────────────────────────────────────────────────────────────────────────────
// Para usar: descomente a linha abaixo em main(), rode o app UMA vez, recomente.
